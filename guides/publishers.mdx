...
<Note>
This page is **gateway mode**: your traffic is proxied through
`gateway.apiosk.com` and the gateway issues the `402`. If you would rather keep
your own URL and your own traffic — with the `402` issued by a middleware running
on your host — see [SDK Mode](/guides/sdk-mode). Discovery, pricing, verification
and payouts work the same either way.
</Note>
