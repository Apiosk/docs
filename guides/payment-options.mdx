...
You can pin the rail per request with `X-Payment-Rail: sepa`. If you omit the header, the gateway auto-selects the cheapest viable rail and falls back when the preferred rail is unavailable.
