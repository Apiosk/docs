...
The `402` may offer more than one settlement network (Base, Polygon, or Arbitrum), pick any listed entry; the price is the same on all of them. See [Multi-chain Settlement](/guides/multichain).
