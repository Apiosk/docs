...
- read the wallet address, spend limits, and funding state (`apiosk_connect` over MCP)
...
- **Local wallet:** run the local stdio MCP package and create a wallet with `apiosk_connect`. State is stored locally under `~/.apiosk`.
