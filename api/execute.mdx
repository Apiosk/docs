...
```json
{
  "id": "6f0b…",
  "status": "completed",
  "question": "Run company_registry.search on kvk",
  "plan": {
    "quote_ref": "b41c…",
  ...
  "results": [
    {
      "result_ref": "a72e…",
      "source": { "provider": "kvk", "name": "KVK" },
      "data": { "companies": [{ "kvkNummer": "30197151", "naam": "Mollie B.V." }] }
    }
  ],
  "usage": {
    "sources": [
      { "source_id": "kvk", "operation": "company_registry.search", "calls": 1,
...
Where the result came from: source, operation, retrieval time, source link,
subject, identifiers such as a KVK number, and cost. Present on every entry of
