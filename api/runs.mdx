...
```json
{
  ...
  "answer": {
    "status": "completed",
    "observations": [{ "text": "The registry lists KVK number 30197151.", "evidence": [{ "result_ref": "a72e…", "pointer": "/data/companies/0/kvkNummer" }] }],
    "limitations": []
  },
  "results": [{ "result_ref": "a72e…", "source": { "provider": "kvk", "name": "KVK" }, "data": {} }],
  "usage": {
    "sources": [{ "source_id": "kvk", "operation": "company_registry.search", "calls": 1, "cost": {} }],
